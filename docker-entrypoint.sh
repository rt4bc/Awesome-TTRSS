...
git checkout -- /var/www/ttrss/classes/urlhelper.php
...
sh /wait-for.sh $DB_HOST:$DB_PORT -- php /initialize.php && sudo -E -u nobody php /var/www/ttrss/update.php --update-schema=force-yes && exec s6-svscan /etc/s6/
